...
- **JS frameworks (React, Vue, Svelte, Angular, React Native)** — the `@hugeicons/*` package is a _renderer only_. Icons are
...
- **Flutter** — the `hugeicons` package _bundles_ the icon data. Icons are `HugeIcons.*`
