...
- **M3 – Motion & scatter** _(F2, F4, G1–G3):_ cloner + effector, cameras as first-class objects (lights moved into M0X), animation model + timeline + curve editor, animatable material/generator params.
...
- **M5 – UV & polish** _(I1–I2, A6):_ UV editor, xatlas unwrap, **texture-mode projection gizmo (inherited from E4 — enables the ToolRail's disabled Texture mode)**, render-to-image, settings page (incl. undo memory budget), shortcut remapping, layout presets.
