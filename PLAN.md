...
- **M3 – Scatter & cameras** _(F2, F4; + fix Area-light LTC crash):_ cloner + effector, cameras as first-class objects (lights moved into M0X). Done when: 100k instances @60fps, any camera bindable to any pane, area lights don't crash.
